function [ f, g ] = fg_synthetic( mu, sys )
%
%% PURPOSE:
%
% To evaluate the L-infinity norm of the (reduced) synthetic example and
% its gradient at the parameter μ.
...
v = V( :, 1 );
%
dH = -Cmu/( 1i*z*Emu - Amu )*( -A2 )*( ( 1i*z*Emu - Amu)\Bmu );
%
g = real( u'*dH*v );
%
return