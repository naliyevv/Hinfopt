...
% =========================================================================
    ...
    function [alpha, x_ls, f_ls, g_ls, fail] = linesearchDescent(x,f,g,p)
        ...
        if constrained && fail == 2
            ...
            for j = 1:reattempts
                ...
                if print_level > 1
                    printer.lineSearchRestart(mu_ls);
                end
    ...
    function [  stat_vec,   ...
        ...
        if print_level > 2 && ~isempty(ME)
            printer.qpError(ME,'TERMINATION');
        end
    end
